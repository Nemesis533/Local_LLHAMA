                    ...
                    if len(parts) >= 9:
                        try:
                            gpu_info = {
                                "index": int(parts[0]),
                                "name": parts[1],
                                "temperature": float(parts[2]) if parts[2] not in ['[N/A]', 'N/A', ''] else None,
                                "utilization_percent": float(parts[3]) if parts[3] not in ['[N/A]', 'N/A', ''] else None,
                                "memory_utilization_percent": float(parts[4]) if parts[4] not in ['[N/A]', 'N/A', ''] else None,
                                "memory_used_mb": float(parts[5]) if parts[5] not in ['[N/A]', 'N/A', ''] else None,
                                "memory_total_mb": float(parts[6]) if parts[6] not in ['[N/A]', 'N/A', ''] else None,
