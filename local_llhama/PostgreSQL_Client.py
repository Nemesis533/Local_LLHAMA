...
class PostgreSQLClient:
    ...
    def execute_query(self, query: str, params: Tuple = ()) -> List[Tuple]:
        ...
        try:
            ...
            print(f"{self.class_prefix_message} [{LogLevel.CRITICAL.name}] Query execution failed: {str(e)}")
            raise
    ...
    def execute_write_returning(self, query: str, params: Tuple = ()) -> Optional[Tuple]:
        """
    ...
    def execute_write_returning_dict(self, query: str, params: Tuple = ()) -> Optional[Dict]:
        """
    ...
    async def execute_one_async(self, query: str, params: Tuple = ()) -> Optional[Tuple]:
        """
    ...
    async def execute_write_returning_async(self, query: str, params: Tuple = ()) -> Optional[Tuple]:
        """
    ...
    def create_conversation(self, user_id: int, title: Optional[str] = None) -> str:
        ...
        @raises Exception If insertion fails.
        """
        query = "INSERT INTO conversations (user_id, title) VALUES (%s, %s) RETURNING id"
    ...
    async def create_conversation_async(self, user_id: int, title: Optional[str] = None) -> str:
        """
        ...
        @raises Exception If insertion fails.
        """
        query = "INSERT INTO conversations (user_id, title) VALUES ($1, $2) RETURNING id"
    ...
    async def list_user_conversations_async(self, user_id: int, limit: int = 50) -> List[Dict]:
        """
    ...
    async def insert_message_async(self, conversation_id: str, role: str, content: str) -> str:
        """
        ...
        result = await self.execute_write_returning_async(query, (conversation_id, role, content))
        return result['id'] if isinstance(result, dict) else result[0] if result else None
    
    async def insert_message_embedding_async(self, message_id: int, vector: List[float]) -> None:
        """
