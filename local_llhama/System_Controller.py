...
class LocalLLHamaSystemController:
    ...
    def __init__(self, base_path):
        ...
        try:
            ...
            print(f"{self.class_prefix_message} [{LogLevel.INFO.name}] PostgreSQL client initialized")
        except Exception as e:
            print(f"{self.class_prefix_message} [{LogLevel.WARNING.name}] PostgreSQL not available: {repr(e)}")
    ...
    def setup_home_assistant(self, loader: SettingLoaderClass):
        ...
        ha_client.initialize_HA(allow_internet_searches=loader.allow_internet_searches, pg_client=self.pg_client)
        print(
