...
class CalendarManager:
    ...
    def get_upcoming_events(self, event_type: Optional[str] = None, 
        ...
        try:
            ...
            print(f"{self.class_prefix_message} {LogLevel.CRITICAL} Failed to get upcoming events: {e}")
            return []
    ...
    def get_event_by_id(self, event_id: int) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"{self.class_prefix_message} {LogLevel.CRITICAL} Failed to get event {event_id}: {e}")
            return None
    ...
    def search_events(self, search_term: str, event_type: Optional[str] = None) -> List[Dict]:
        ...
        try:
            ...
            print(f"{self.class_prefix_message} {LogLevel.CRITICAL} Failed to search events: {e}")
            return []
    ...
    def delete_event(self, event_id: int) -> Tuple[bool, str]:
        ...
        try:
            self.pg_client.execute_write(
                'UPDATE events SET is_active = FALSE WHERE id = %s',
                (event_id,)
            )
