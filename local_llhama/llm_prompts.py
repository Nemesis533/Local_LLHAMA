...
try:
    from local_llhama.settings.prompts import (
        ...
        CALENDAR_EVENT_PROMPT as _RAW_CALENDAR,
    ...
    RESPONSE_PROCESSOR_PROMPT = _inject_assistant_name(_RAW_RESPONSE_PROCESSOR, _assistant_name)
    SMART_HOME_PROMPT_TEMPLATE = _inject_assistant_name(_RAW_SMART_HOME, _assistant_name)
    CONVERSATION_PROCESSOR_PROMPT = _inject_assistant_name(_RAW_CONVERSATION, _assistant_name)
    ...
    SMART_HOME_DECISION_MAKING_EXTENSION = _inject_assistant_name(_RAW_DECISION, _assistant_name)
    ...
    CONVERSATION_PROCESSOR_PROMPT = f"You are {_assistant_name}, a conversational assistant."
...
def is_safety_enabled():
    ...
    try:
        ...
        print(f"[LLM_Prompts] Error checking safety setting: {e}, defaulting to enabled")
...
def reload_prompts(settings_loader=None, system_settings=None):
    ...
    try:
        ...
        print(f"[LLM_Prompts] Prompts reloaded successfully (assistant: {_assistant_name})")
        return True
