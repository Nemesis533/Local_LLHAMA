...
-- TABLE: automations
-- ============================================================
-- Stores user-defined automation sequences
CREATE TABLE automations (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    user_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
    name TEXT NOT NULL,
    description TEXT,
    actions JSONB NOT NULL,  -- Array of command objects [{action, target, data}, ...]
    is_active BOOLEAN DEFAULT true,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX idx_automation_is_active ON automations(is_active);
CREATE INDEX idx_automation_name ON automations(name);
